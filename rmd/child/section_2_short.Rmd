...
---
Section II provides a tabular summary of all accepted results from each sampling location. Descriptive tables for each site include applicable established WQS (6 NYCRR Part 703), a summary of general chemistry and in-situ results, WQS excursion information, and BAP scores. Water chemistry results are summarized by analyte concentration after meeting QA/QC standards. WQS excursion information identifies excursions of the applicable WQS. BAP score information includes mean BAP score, standard deviation, standard error, and number of replicates. 
...
#sites.l<-merge(sites.add,sites.l)
 ...
 for (i in seq_along(sites.l)) { 
  ...
  #label=paste("Applicable Standards:",sites.l[i])
  tab<-flextable::set_caption(tab,tab.cap,style="Table Caption",autonum = run_autonum(seq_id = "tab"))
 # tab<-tab %>% 
 ...
 if (nrow(temp) > 0){ 
  ...
  #label=paste("Chemistry Measurements:",sites.l[i])
  tab1<-flextable::set_caption(tab1,tab.cap,style="Table Caption",autonum = run_autonum(seq_id = "tab"))
  ...
  if (nrow(temp) > 0){ 
   ...
   tab.cap=paste(label)
   tab3<-flextable::set_caption(tab3,tab.cap,style="Table Caption",autonum = run_autonum(seq_id = "tab"))
  ...
  tab.cap=paste(label)
  tab6<-flextable::set_caption(tab6,tab.cap,style="Table Caption",autonum = run_autonum(seq_id = "tab"))
