...
```{r tab.id= "Analytes", tab.cap="Water chemistry analytes sampled as part of the Stream Assessment Survey. Table lists sampled analytes and analytical specifications.", echo=FALSE, message=FALSE, warning=FALSE}
