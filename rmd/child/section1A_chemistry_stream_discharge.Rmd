...
tl.1<-align(tl.1, i = NULL, j =(2:10) , align = "center", part = "all")%>%
  ...
  width(j=1, width=1.2)
tl.1<-flextable::set_caption(tl,caption=("Water chemistry analytes sampled as part of the Stream Assessment Survey. Table lists sampled analytes and analytical specifications."),style="Table Caption",autonum = run_autonum(seq_id = "tab",prop=officer::fp_text_lite(bold = FALSE)))
