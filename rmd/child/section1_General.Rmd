...
```{r site-map, echo=FALSE, fig.cap="Map of sampling locations. Site names reference the Location ID and River Mile.", fig.align='center',fig.cap.style="Image Caption",message=FALSE, warning=FALSE}
