...
ft <- fp_text(shading.color='#EFEFEF', bold = FALSE)
...
```{r if(params$bap){child="child/section1B_BAP.Rmd"}}
if(params$bap){cat("## Benthic Macroinvertebrate Community")}
...
```{r if(params$habitat){child="child/section1C_stream_reach_phys.Rmd"}}
if(params$habitat){cat("## Stream Reach Physical Habitat Characteristics")}
